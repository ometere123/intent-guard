...
| Bonded `request_review` for `IG-PROOF-1` | PASS | `0x40b50e6a7f7950250e111d5371afa1f3cc6f15fd731ba4405ea4aa94019c237f`: FINALIZED, GenVM `SUCCESS`, 0.001 GEN bond attached. |
| Consensus `review` for `IG-PROOF-1` | PASS | `0x8f04f376045240d6be4ac83f31f3e4eda0bea82890aecc2e4bed60a23425dd46`: FINALIZED, GenVM `SUCCESS`, 5 executions SUCCESS / 1 non-fatal ERROR, votes `DISAGREE, AGREE, AGREE, IDLE, AGREE`. |
| Bonded `request_review` for `IG-PROOF-2` | PASS | `0xba9dc4e66e7ea155c308deb8d43bd32a8c248f8ae369ba6b274e2d14681cedea`: FINALIZED, GenVM `SUCCESS`, `value_credited: true`, 4 executions SUCCESS / 2 non-fatal ERROR, votes `IDLE, AGREE, IDLE, AGREE, AGREE`. |
| Consensus `review` for `IG-PROOF-2` | PASS | `0xa78a692eda0f08a0f3aa3c8f1520ae3af224bd4b16b42bef6dd52f4e435bcd2e`: FINALIZED, GenVM `SUCCESS`, 5 executions SUCCESS / 0 ERROR, votes `AGREE, DISAGREE, AGREE, AGREE`. |
